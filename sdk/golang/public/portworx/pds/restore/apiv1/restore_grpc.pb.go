...
func (c *restoreServiceClient) CreateRestore(ctx context.Context, in *CreateRestoreRequest, opts ...grpc.CallOption) (*Restore, error) {
	...
	out := new(Restore)
	err := c.cc.Invoke(ctx, RestoreService_CreateRestore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restoreServiceClient) GetRestore(ctx context.Context, in *GetRestoreRequest, opts ...grpc.CallOption) (*Restore, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Restore)
	err := c.cc.Invoke(ctx, RestoreService_GetRestore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *restoreServiceClient) RecreateRestore(ctx context.Context, in *RecreateRestoreRequest, opts ...grpc.CallOption) (*Restore, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Restore)
	err := c.cc.Invoke(ctx, RestoreService_RecreateRestore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
