...
var file_public_portworx_pds_catalog_images_apiv1_images_proto_goTypes = []any{
...
func file_public_portworx_pds_catalog_images_apiv1_images_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_public_portworx_pds_catalog_images_apiv1_images_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Image); i {
			case 0:
				return &v.state
			case 1:
		...
		file_public_portworx_pds_catalog_images_apiv1_images_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Info); i {
			case 0:
				return &v.state
			case 1:
		...
		file_public_portworx_pds_catalog_images_apiv1_images_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_public_portworx_pds_catalog_images_apiv1_images_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_public_portworx_pds_catalog_images_apiv1_images_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_public_portworx_pds_catalog_images_apiv1_images_proto_msgTypes[5].Exporter = func(v any, i int) any {
