...
var file_public_portworx_pds_copilot_apiv1_copilot_proto_goTypes = []any{
...
func file_public_portworx_pds_copilot_apiv1_copilot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_public_portworx_pds_copilot_apiv1_copilot_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_public_portworx_pds_copilot_apiv1_copilot_proto_msgTypes[1].Exporter = func(v any, i int) any {
