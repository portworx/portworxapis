...
var file_public_portworx_platform_login_apiv1_login_proto_rawDesc = []byte{
	...
	0x0b, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x55, 0x72, 0x6c, 0x32, 0xbb, 0x03, 0x0a,
	...
	0x68, 0x3a, 0x6f, 0x69, 0x64, 0x63, 0x49, 0x6e, 0x66, 0x6f, 0x42, 0x79, 0x0a, 0x25, 0x63, 0x6f,
	...
	0x01, 0x5a, 0x42, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x75,
	0x72, 0x65, 0x2d, 0x70, 0x78, 0x2f, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x2f, 0x70, 0x6f, 0x72, 0x74, 0x77, 0x6f, 0x72, 0x78, 0x2f, 0x70, 0x6c, 0x61, 0x74, 0x66,
	0x6f, 0x72, 0x6d, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x76, 0x31, 0x3b,
...
var file_public_portworx_platform_login_apiv1_login_proto_goTypes = []interface{}{
...
var file_public_portworx_platform_login_apiv1_login_proto_depIdxs = []int32{
	...
	1, // 7: public.portworx.platform.login.v1.LoginService.Login:output_type -> public.portworx.platform.login.v1.LoginResponse
	4, // 8: public.portworx.platform.login.v1.LoginService.RefreshToken:output_type -> public.portworx.platform.login.v1.RefreshTokenResponse
	5, // 9: public.portworx.platform.login.v1.LoginService.GetOIDCInfo:output_type -> public.portworx.platform.login.v1.OIDCInfo
...
func file_public_portworx_platform_login_apiv1_login_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_public_portworx_platform_login_apiv1_login_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_public_portworx_platform_login_apiv1_login_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_public_portworx_platform_login_apiv1_login_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Claims); i {
			case 0:
				return &v.state
			case 1:
		...
		file_public_portworx_platform_login_apiv1_login_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_public_portworx_platform_login_apiv1_login_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_public_portworx_platform_login_apiv1_login_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
