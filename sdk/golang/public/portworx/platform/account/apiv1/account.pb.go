...
// Desired configuration of the account.
// @param dns_name has been deprecated and moved to config management.
type Config struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
var file_public_portworx_platform_account_apiv1_account_proto_rawDesc = []byte{
	...
	0xe0, 0x41, 0x03, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xa6, 0x06, 0x0a, 0x06,
	...
	0x09, 0x75, 0x73, 0x65, 0x72, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x12, 0x26, 0x0a, 0x0c, 0x64, 0x69,
...
var file_public_portworx_platform_account_apiv1_account_proto_goTypes = []any{
...
func file_public_portworx_platform_account_apiv1_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*Phase); i {
			case 0:
				return &v.state
			case 1:
		...
		file_public_portworx_platform_account_apiv1_account_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Status); i {
			case 0:
				return &v.state
			case 1:
	...
	file_public_portworx_platform_account_apiv1_account_proto_msgTypes[3].OneofWrappers = []any{
