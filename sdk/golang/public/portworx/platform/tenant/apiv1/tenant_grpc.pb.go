...
const (
	...
	TenantService_GetResourceCount_FullMethodName = "/public.portworx.platform.tenant.v1.TenantService/GetResourceCount"
)
...
type TenantServiceClient interface {
	...
	GetResourceCount(ctx context.Context, in *GetResourceCountRequest, opts ...grpc.CallOption) (*GetResourceCountResponse, error)
}
...
func (c *tenantServiceClient) GetResourceCount(ctx context.Context, in *GetResourceCountRequest, opts ...grpc.CallOption) (*GetResourceCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResourceCountResponse)
	err := c.cc.Invoke(ctx, TenantService_GetResourceCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TenantServiceServer interface {
	...
	//
	// GetResourceCount will fetch the count of each resource under the given Tenant (Organization).
	GetResourceCount(context.Context, *GetResourceCountRequest) (*GetResourceCountResponse, error)
...
func (UnimplementedTenantServiceServer) GetResourceCount(context.Context, *GetResourceCountRequest) (*GetResourceCountResponse, error) {
...
func _TenantService_GetResourceCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetResourceCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).GetResourceCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_GetResourceCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).GetResourceCount(ctx, req.(*GetResourceCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TenantService_GetResourceCount_Handler,
		},
	},
