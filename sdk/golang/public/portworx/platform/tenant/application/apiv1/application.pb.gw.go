...
func request_ApplicationService_ListAvailableApplications_0(ctx context.Context, marshaler runtime.Marshaler, client ApplicationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListAvailableApplicationsRequest
	...
	msg, err := client.ListAvailableApplications(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ApplicationService_ListAvailableApplications_0(ctx context.Context, marshaler runtime.Marshaler, server ApplicationServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListAvailableApplicationsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListAvailableApplications(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterApplicationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ApplicationServiceServer) error {
	...
	mux.Handle("GET", pattern_ApplicationService_ListAvailableApplications_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ApplicationService_ListAvailableApplications_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_ApplicationService_ListAvailableApplications_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterApplicationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ApplicationServiceClient) error {
	...
	mux.Handle("GET", pattern_ApplicationService_ListAvailableApplications_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ApplicationService_ListAvailableApplications_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_ApplicationService_ListAvailableApplications_0 = runtime.ForwardResponseMessage
)
