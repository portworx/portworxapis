...
type ProjectServiceClient interface {
	...
	//
	// List Projects API lists the projects visible to the caller for the provided Tenant (Organization).
...
func (c *projectServiceClient) AssociateResources(ctx context.Context, in *AssociateResourcesRequest, opts ...grpc.CallOption) (*Project, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Project)
	err := c.cc.Invoke(ctx, ProjectService_AssociateResources_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *projectServiceClient) DisassociateResources(ctx context.Context, in *DisassociateResourcesRequest, opts ...grpc.CallOption) (*Project, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Project)
	err := c.cc.Invoke(ctx, ProjectService_DisassociateResources_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
