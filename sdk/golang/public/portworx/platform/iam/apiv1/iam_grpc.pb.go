...
type IAMServiceClient interface {
	...
	ListIAMPermissions(ctx context.Context, in *ListIAMPermissionsRequest, opts ...grpc.CallOption) (*ListIAMPermissionsResponse, error)
...
func (c *iAMServiceClient) CreateIAM(ctx context.Context, in *CreateIAMRequest, opts ...grpc.CallOption) (*IAM, error) {
	...
	out := new(IAM)
	err := c.cc.Invoke(ctx, IAMService_CreateIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) GrantIAM(ctx context.Context, in *GrantIAMRequest, opts ...grpc.CallOption) (*GrantIAMResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMService_GrantIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) RevokeIAM(ctx context.Context, in *RevokeIAMRequest, opts ...grpc.CallOption) (*RevokeIAMResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMService_RevokeIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) GetIAM(ctx context.Context, in *GetIAMRequest, opts ...grpc.CallOption) (*IAM, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IAM)
	err := c.cc.Invoke(ctx, IAMService_GetIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) ListIAMPermissions(ctx context.Context, in *ListIAMPermissionsRequest, opts ...grpc.CallOption) (*ListIAMPermissionsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListIAMPermissionsResponse)
	err := c.cc.Invoke(ctx, IAMService_ListIAMPermissions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) UpdateIAM(ctx context.Context, in *UpdateIAMRequest, opts ...grpc.CallOption) (*IAM, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IAM)
	err := c.cc.Invoke(ctx, IAMService_UpdateIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) DeleteIAM(ctx context.Context, in *DeleteIAMRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, IAMService_DeleteIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *iAMServiceClient) ListIAM(ctx context.Context, in *ListIAMRequest, opts ...grpc.CallOption) (*ListIAMResponse, error) {
	...
	err := c.cc.Invoke(ctx, IAMService_ListIAM_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IAMServiceServer interface {
	...
	// ListIAMPermissions API list permissions for Roles in IAM.
	ListIAMPermissions(context.Context, *ListIAMPermissionsRequest) (*ListIAMPermissionsResponse, error)
	// UpdateIAM API updates IAM with the new set of role bindings. The request replaces the existing set of bindings.
...
func (UnimplementedIAMServiceServer) ListIAMPermissions(context.Context, *ListIAMPermissionsRequest) (*ListIAMPermissionsResponse, error) {
...
func _IAMService_ListIAMPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListIAMPermissionsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IAMServiceServer).ListIAMPermissions(ctx, req.(*ListIAMPermissionsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
